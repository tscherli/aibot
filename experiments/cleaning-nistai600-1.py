...
class NistCleaner:
    """Handles the transformation of raw NIST AI 600-1 Markdown into RAG-ready text."""
    
    def __init__(self, anchor_text: str = "## 1. Introduction"):
        # Set anchor to Introduction to skip the title pages and TOC
        self.anchor_text = anchor_text
        self.table_sanitizer = TableSanitizer()
        
        # Updated patterns specific to NIST AI 600-1
        self.junk_patterns = [
            r"NIST AI 600-1",
            r"NIST Trustworthy and Responsible AI",
            r"Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile",
            r"This publication is available free of charge from: https://doi\.org/10\.6028/NIST\.AI\.600-1",
            r"July 2024",
...
def main():
    # File configuration updated for NIST AI 600-1
    INPUT_PATH = r"C:\aibot\data\02_clean_markdown\NIST.AI.600-1.md"
    OUTPUT_PATH = r"C:\aibot\data\02_clean_markdown\NIST.AI.600-1_CLEANED2.md"
    ...
    try:
        ...
        logger.info("Executing Sanitization Pipeline (Tailored for NIST AI 600-1)...")
