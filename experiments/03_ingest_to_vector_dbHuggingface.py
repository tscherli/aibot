...
class NISTMetadataSplitter:
    ...
    def __init__(self, model_id: str, chunk_size: int, overlap: int):
        ...
        self.text_splitter = RecursiveCharacterTextSplitter.from_huggingface_tokenizer(
            ...
            # Priority: Headers > Paragraphs > Tables > Lines
            separators=["\n# ", "\n## ", "\n\n", "\n|", "\n", " ", ""]
        )
...
def main():
    try:
        ...
        splitter = NISTMetadataSplitter(MODEL_ID, CHUNK_SIZE, CHUNK_OVERLAP)
